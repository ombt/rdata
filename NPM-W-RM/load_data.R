#
sqlite_load_npm_w_rm <- function(nrows=0)
{
    return(sqlite_load_u0x("NPM-W-RM",nrows))
}

sqlite_load_nv_npm_w_rm <- function(nrows=0)
{
    return(sqlite_load_nv_u0x("NPM-W-RM",nrows))
}
